...
class Client
    ...
    constructor() {
        ...
        document.title = "Voice Generation";
    ...
    onClickSend(e) {
        ...
        if (this.state.checkContactData) {
            ...
            if (this.state.phone !== "") cli_data.cli_phone = Client.formatPhone(this.state.phone);
        }
    ...
    onChangePhone(e) {
        ...
        const formatPhone = Client.formatPhone(phone);
